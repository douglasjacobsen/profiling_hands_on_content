...
# Vtune:
# srun -n ${NPROCS} --cpu_bind=cores -- amplxe-cl -c <collection> -r $SCRATCH/<result> -finalization-mode=deferred -- <EXE> <ARGS>
...
# srun -n ${NPROCS} --cpu_bind=cores -- inspxe-cl -c <collection> -r $SCRATCH/<result> -no-auto-finalize -- <EXE> <ARGS>
