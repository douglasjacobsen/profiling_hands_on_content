...
// Run a smaller problem for debugging purposes
  ...
  double nppc               = 256;     // Ave. number of particles/cell in ea. species
...
// Here _He is N3+
  ...
  double nx                = 1024;//was 7776
  double ny                = 1;   //was 1
  double nz                = 512; //was 549
...
//double cell_size_y       = hy*delta/debye;
  ...
  double topology_x        = nproc(); //was nproc()
  double topology_y        = 1;
  double topology_z        = 1;            
...
//e0                       = e0*(waist/width);    // at entrance (3D Gaussian) 
  ...
  //dt = dt*100; //decrease time for testing/debugging


  double wpe1ps = 1e-12*c_vac/delta;

  double t_stop            = 0.01*wpe1ps;               // Runtime in 1/wpe
